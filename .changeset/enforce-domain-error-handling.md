...
**Breaking:** the factory is now called as `makeLoaderOrActionFactory<DomainErrors>()({ errorHandlers })` (note the extra `()`), and registered handlers must be keyed by a declared domain error.
